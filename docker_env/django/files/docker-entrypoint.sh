...
rm -rf /data/www/backend/celerybeat.pid
...
/usr/local/dev/bin/python3 manage.py collectstatic --noinput 
/usr/local/dev/bin/python3 manage.py makemigrations 
/usr/local/dev/bin/python3 manage.py migrate  
