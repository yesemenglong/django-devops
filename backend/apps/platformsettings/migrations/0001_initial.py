# Generated by Django 4.0.8 on 2023-05-16 16:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_item_type', models.SmallIntegerField(blank=True, choices=[(0, 'text'), (1, 'datetime'), (2, 'date'), (3, 'textarea'), (4, 'select'), (5, 'checkbox'), (6, 'radio'), (7, 'image'), (8, 'file'), (9, 'switch'), (10, 'number'), (11, 'array'), (12, 'images'), (13, 'time'), (14, 'richtext')], default=0, help_text='表单类型', null=True, verbose_name='表单类型')),
